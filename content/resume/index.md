...
## University of Pittsburgh, BS in Computer Information Systems and Technolgy
...
## IPTO3SSC | Obscurity Labs, Software Engineer
...
## American Refining Group, Software Engineering Intern
...
## Islamic Center of Pittsburgh, IT Support Technician
...
## Magitech PC, Freelance Full Stack Web Developer
...
## Cinemark Theaters, Concessionaire Team Manager
...
- Apr 2023
- Engineered a comprehensive suite of functionality, including capturing specific screen regions, screen recording, and buffered recording for screen history. This enhances the user’s ability to document and review desktop activity.
- Implemented a seamless recording experience encompassing desktop audio, user microphone audio, and desktop video. Consolidated these settings into an intuitive UI delivering user-friendly .mp4 files for efficient review

## [Infrared Universal Remote Mobile Application](https://github.com/FizleWit/IRRemoteApp)

- Apr 2022
- Recorded IR frequencies using an Arduino, enabling users to replicate and control IR device functions.
- Employed Android’s Consumer IR Manager package to maximize Infrared communication capabilities. This enabled the. application to interact effectively with a wide range of IR device.

## [HomeLab Services](https://example.com)
